...
- Claude API (web search 포함) → 오늘의 시장 뉴스 수집 + 기획안 생성
...
GMAIL_ADDRESS    = os.environ["GMAIL_ADDRESS"]      # 보내는 사람 (본인 Gmail)
GMAIL_APP_PW     = os.environ["GMAIL_APP_PW"]       # Gmail 앱 비밀번호
RECIPIENT_EMAIL  = os.environ.get("RECIPIENT_EMAIL", GMAIL_ADDRESS)  # 받는 사람 (기본=본인)
# ─────────────────────────────────────────────────────
...
def generate_content_plan() -> str:
    """Claude API + web search로 오늘의 콘텐츠 기획안 생성"""
...
1. 미국 증시 — 초보자도 스스로 시장을 읽을 수 있도록 돕는 콘텐츠
   (주식 리딩방 의존 NO, 스스로 판단하는 투자자 육성이 목표)
...
지금 당장 웹에서 오늘자 미국 증시 관련 주요 뉴스와 AI/테크 비즈니스 트렌드를 검색하고,
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📸 인스타 카드뉴스 주제 (주 3회 중 오늘 해당 여부 포함)
• 주제: [제목]
...
def send_email(content: str):
    ...
    <html><body style="font-family: 'Apple SD Gothic Neo', sans-serif;
      ...
      <p style="color:#999; font-size:12px; margin-top:24px; text-align:center;">
        자동 생성된 콘텐츠 기획안입니다. Powered by Claude + GitHub Actions
      </p>
    </body></html>
    """
